package com.userfront.domain.service.UserServiceImpl;
...
public class TransactionServiceImpl implements TransactionService {
	...
	public List<SavingsTransaction> findSaveTransactionList(String username){
		User user = userService.findByUsername(username);
	...
	public List<Recipient> findRecipientList(Principal principal) {
		...
		// TO DO: IMPROVE RETRIEVING LIST OF RECIPIENTS
	...
	public void toSomeoneElseTransfer(Recipient recipient, String accountType, String amount,
		...
		if(accountType.equalsIgnoreCase("Primary")){
			...
			PrimaryTransaction primaryTransaction = new PrimaryTransaction(date, "Transfer to recipient " + recipient.getName(),
			...
			SavingsTransaction savingsTransaction = new SavingsTransaction(date, "Transfer to recipient " + recipient.getName(), "Transfer",
