...
public class TransferController {
	...
	public String betweenAccountsPost(@ModelAttribute("transferFrom") String transferFrom, 
			@ModelAttribute("transferTo") String transferTo, @ModelAttribute("amount") String amount, Principal principal) throws Exception
	{
	...
	public String recipientPost(@ModelAttribute("recipient") Recipient recipient, Principal principal){
		...
		User user = userService.findByUsername(principal.getName());
		recipient.setUser(user); // Associates Recipients to specific user
